---
title: "Multi-sheet XLS/XLSX resources"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Multi-sheet XLS/XLSX resources}
...
There are also cases where the file contains multiple sheets and it would be helpful to have them all together as a single data set. For exampe, the [2019 TTC Bus Delay Data](https://open.toronto.ca/dataset/ttc-bus-delay-data/):
